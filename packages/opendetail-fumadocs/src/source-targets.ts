import type {
  AssistantSourceItem,
  AssistantSourceTarget,
  ResolveAssistantSourceTarget,
} from "opendetail-react";

export type OpenDetailSourceLike = AssistantSourceItem;
export type OpenDetailSourceTarget = AssistantSourceTarget;

export interface FumadocsPageUrlSource {
  getPages(): Array<{
    url: string;
  }>;
}
...
export const getFumadocsPageUrls = (source: FumadocsPageUrlSource): string[] =>
