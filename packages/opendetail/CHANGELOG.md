...
- 8ee06da: Restructure OpenDetail around clearer adoption paths and package boundaries.
...
- a8a0637: Config schema v1 and fetch namespace consolidation.
...
- 577809d: Add a broader `0.3.0` release for `opendetail` built from the work landed after `0.2.0`.
  ...
  - Add a setup-focused CLI with `opendetail setup` and `opendetail doctor`, including interactive scaffolding, config generation, optional Next.js route generation, and index building.
  - Add `createNextRoute` plus a clearer self-hosted integration story in the package surface and docs.
