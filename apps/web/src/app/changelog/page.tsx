    ...
    <div className="w-full pb-12 tracking-tight">
      <ChangelogEntry date="6 Apr 2026" version="v1.0.0">
        ...
        <ChangelogParagraph>
          ...
          <strong>AssistantShell</strong>, <strong>AssistantSidebarShell</strong>
          , <strong>AssistantError</strong>, <strong>AssistantInput</strong>,{" "}
          <strong>AssistantResponse</strong>, <strong>AssistantThread</strong>,{" "}
          <strong>AssistantUserMessage</strong>, <strong>AssistantLoader</strong>
          ) are removed. The public API uses{" "}
        ...
        <ChangelogParagraph>
          ...
          <strong>AssistantSidebar</strong> with a{" "}
          <em>connection</em> prop—the same <em>endpoint</em>,{" "}
          <em>persistence</em>, <em>sitePaths</em>, and <em>transport</em>{" "}
          props as before, wired through the stable connection shape.
        </ChangelogParagraph>
        <ChangelogChanges>
          <ChangelogListItem>
            Protocol-relative source URLs (<code className="rounded-md bg-neutral-100 px-1.5 py-0.5 font-mono font-normal text-[13px] text-neutral-900 tracking-tight">//host/…</code>) are rejected in citation helpers so local-path links cannot navigate off-site.
          </ChangelogListItem>
          <ChangelogListItem>
            Stable <code className="rounded-md bg-neutral-100 px-1.5 py-0.5 font-mono font-normal text-[13px] text-neutral-900 tracking-tight">useOpenDetail</code> callbacks (<em>clearThread</em>, <em>stop</em>, <em>submit</em>) via ref indirection; sidebar and modal components are fully memoized.
          </ChangelogListItem>
          <ChangelogListItem>
            Styles split into <em>systems</em> and <em>themes</em> sub-directories; root <em>opendetail-*.css</em> imports stay stable.
          </ChangelogListItem>
        </ChangelogChanges>
      </ChangelogEntry>
      ...
      <ChangelogEntry date="6 Apr 2026" version="v0.6.0">
        ...
        <ChangelogParagraph>
          Large sidebar refresh built on the new{" "}
          <strong>trifold</strong> package — mobile multi-column layout with
          drag-to-snap gestures, a resizable desktop sidebar, nested nav rail
          behavior, embed/reopen affordances, reworked{" "}
          <strong>Composer</strong> input, richer source rendering with{" "}
          <strong>suggestions</strong>, and an updated{" "}
        ...
        <ChangelogChanges>
          <ChangelogListItem>
            <strong>trifold</strong> package published: parallel column layout primitives (<em>Trifold</em>, <em>ParallelTrack</em>, <em>ScrollPanels</em>), gesture math for drag/snapping.
          </ChangelogListItem>
          <ChangelogListItem>
            <strong>FumadocsAssistantSidebar</strong> renamed to <strong>FumadocsAssistant</strong>; import from <code className="rounded-md bg-neutral-100 px-1.5 py-0.5 font-mono font-normal text-[13px] text-neutral-900 tracking-tight">opendetail-fumadocs/assistant</code>.
          </ChangelogListItem>
          <ChangelogListItem>
            Zod-backed config validation for <em>site_pages</em> / <em>site_pages_fetch</em> with path normalization and expanded public type exports.
          </ChangelogListItem>
        </ChangelogChanges>
      </ChangelogEntry>
