    ...
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col justify-center px-6 py-16">
      <div className="max-w-3xl">
        ...
        <p className="mt-5 max-w-2xl text-fd-muted-foreground text-lg leading-8">
          ...
          This site now holds the marketing surface at `/`, the docs at `/docs`,
          the demo at `/demo`, and the registry payloads under `/r`.
        </p>
      </div>
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-4">
        ...
        >
          ...
          <p className="mt-2 text-fd-muted-foreground text-sm">
            Open the assistant overlay against the live demo surface.
          </p>
        </Link>
      </div>
    </main>
